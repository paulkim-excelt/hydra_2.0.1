...
##  @defgroup grp_rtpvidrcvr_wifi Wifi RTP Video Receiver
#   @ingroup grp_applications
#
#   @addtogroup grp_rtpvidrcvr_wifi
#   @{
#   @image html rtpvidrcvr_overview.jpg "RTP Video Receiver Overview"
#   This application initializes RTP Listener, AVC decoder, Graphics Source and VGC (Display)
#   components to receive encoded video content over WiFi using INET Stack. It decode and display the
#   content with Graphics blending. This application uses the standard Media Framework as described in
#   @ref grp_framework.
#
#   @section sec_rtpvidrcvr_wifi_hardware_setup   Setting up the board for wifi card
...
#
#   @section sec_rtpvidrcvr_wifi_target Running the application on target
#   -# Follow the steps mentioned in Quick Start Guide @ref subsec_qsg_flash_segger
#   -# This application can run only on BCM89107 EVK and with Display.
#   -# Setup a BCM8910X_EVK (Rev-C) board with wifi card @b rtpvidxmtr_wifi flashed on it.
#   -# Setup a BCM89107 Wifi rtp transmitter as mentioned in @ref grp_rtpvidxmtr_wifi
#   -# Reset receiver board
#   -# Reset transmitter board
#   -# Camera content can be seen the receiver
#
#   @note This application uses UDP for streaming compressed data.
#
#   @file applications/rtpvidrcvr_wifi/comp.mk
#   @brief Makefile for Wifi RTP Video Receiver application
#   @version 0.1 Initial version
#   @}
#


BRCM_SRC := $(BRCM_SDK_ROOT)/applications/rtpvidrcvr_wifi/rtpvidrcvr.c

BRCM_CFLAGS += -DMEDIA_SYSTEM_MAX_VIDEO_WIDTH=1280UL
BRCM_CFLAGS += -DMEDIA_SYSTEM_MAX_VIDEO_HEIGHT=720UL
BRCM_CFLAGS += -DMEDIA_SYSTEM_MAX_VIDEO_FPS=5UL
...
BRCM_COMP_NAME := rtpvidrcvr_wifi
BRCM_COMP_DEPENDS := vgc_display pplib avcd rtp inet ets wlandrv sddrv
BRCM_COMP_TYPE := app
