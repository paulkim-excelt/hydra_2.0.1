...
BRCM_SRC := $(BRCM_SDK_ROOT)/applications/vidxmtr1080p30/vidxmtr.c

BRCM_CFLAGS += -DLDC_MEMPOOL_SIZE=\(\(18*1920*16\)+\(18*1024*8*2\)\)
BRCM_CFLAGS += -DLDC_MP_MATRIX_DATA_SIZE=\(\(8*1920*1088\)/256\)

BRCM_CFLAGS += -DAVBT_MAX_NUM_INPUT_PORTS=1UL
BRCM_CFLAGS += -DMEDIA_SYSTEM_MAX_VIDEO_WIDTH=1920UL
BRCM_CFLAGS += -DMEDIA_SYSTEM_MAX_VIDEO_HEIGHT=1080UL
...
BRCM_CFLAGS += -DLDC_TOTAL_YUV_BUFFERS=10UL
BRCM_CFLAGS += -DAVCE_TOTAL_YUV_BUFFERS=6UL
...
BRCM_COMP_NAME := vidxmtr1080p30
BRCM_COMP_DEPENDS := pplib avce isys 1722 ets ldc
