...
##  @defgroup grp_vidxmtr_right_node Video Transmitter(Right Node)
#   @ingroup grp_vidxmtr
#
#   @addtogroup grp_vidxmtr_right_node
#   @{
#   This application is configured to work as a right camera view of a
#   surround view system
#
#   @file applications/vidxmtr/comp1.mk
#   @brief Makefile for VidXmtr Right Node
...
BRCM_COMP_NAME := vidxmtr_right_node
...
BRCM_APP_CFG_XML := bcm8910x_ov9716_right_node
