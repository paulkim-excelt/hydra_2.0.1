...
BRCM_SRC :=
BRCM_SRC += $(BRCM_SDK_ROOT)/applications/vidxmtr/tests/qualification/vidxmtr_qt.c
BRCM_SRC += $(BRCM_SDK_ROOT)/applications/vidxmtr/tests/qualification/ex_sink_comp.c
...
BRCM_CFLAGS += -DLDC_TOTAL_YUV_BUFFERS=3UL
...
BRCM_COMP_NAME := vidxmtr_qt
BRCM_COMP_DEPENDS := pplib avce isys 1722 ldc vgc_mwb fqtss
