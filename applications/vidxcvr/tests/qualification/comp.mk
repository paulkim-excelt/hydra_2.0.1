...
BRCM_SRC :=
BRCM_SRC += $(BRCM_SDK_ROOT)/applications/vidxcvr/tests/qualification/vidxcvr_qt.c
BRCM_SRC += $(BRCM_SDK_ROOT)/applications/vidxcvr/tests/qualification/rle.c
...
BRCM_COMP_NAME := vidxcvr_qt
BRCM_COMP_DEPENDS := pplib avce isys 1722 ldc avcd vgc_display
