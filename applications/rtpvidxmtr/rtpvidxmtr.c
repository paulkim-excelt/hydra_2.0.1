...
/**
    ...
    @{
    @file rtpvidxmtr.c
    @brief This file implements the RTP video transmitter application
              with gPTP enabled
...
static const MSYS_Type mediaSys = {
    ...
    .component[4].compID = MSYS_COMP_ID_AVCE,
    .component[4].numConfigs = 2UL,
    .component[4].config[0] = MSYS_CONFIG_AVCE_MOD,
    .component[4].config[1] = MSYS_CONFIG_AVCE_FW0,
    .component[4].portMap[0].srcCompIdx = 3U,
    .component[4].portMap[0].srcPortIdx = 0U,

    .component[5].compID = MSYS_COMP_ID_RTPS,
    .component[5].numConfigs = 1UL,
    .component[5].config[0] = MSYS_CONFIG_RTP_SENDER,
