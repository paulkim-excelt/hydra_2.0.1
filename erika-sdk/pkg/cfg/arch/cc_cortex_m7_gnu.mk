...
ifeq ($(call iseeopt, __CORTEX_M7__), yes)
#OPT_CC += -march=armv7e-m -mcpu=cortex-m7 -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -mthumb-interwork -mlong-calls
OPT_CC += -mcpu=cortex-m7 -mthumb -mthumb-interwork -fno-builtin
endif
...
# Add Debug macro.
# NOTE: move this macro from architecture dependant make files
# to common make file.
ifeq ($(call iseeopt, DEBUG), yes)
OPT_CC += -DDEBUG
OPT_ASM += -DDEBUG
...
ifeq ($(call iseeopt, __CORTEX_M7__), yes)
# MM: Check!!!
#OPT_ASM += -march=armv7e-m -mcpu=cortex-m7 -mfpu=fpv4-sp-d16 -mthumb -mthumb-interwork
OPT_ASM += -mcpu=cortex-m7 -mthumb -mthumb-interwork  -fno-builtin
endif
...
# MM: Check!!!
#OPT_CC += -march=armv7e-m -mcpu=cortex-m7 -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -mthumb-interwork -mlong-calls
OPT_LINK += -mcpu=cortex-m7 -mthumb -mthumb-interwork  -fno-builtin
endif
