...
EABI_GCC_PREFIX := $(COMPILER_PREFIX)
endif
...
OPT_CC += -mcpu=cortex-r4 -mthumb -mthumb-interwork -Wa,-meabi=5
endif

# Addtional compiler options
OPT_CC += -ffunction-sections -fdata-sections -fno-builtin -mtpcs-frame -msoft-float -nostartfiles
...
# Use C99 Standard
OPT_CC += -std=gnu99 -mlittle-endian
...
ifeq ($(call iseeopt, __CORTEX_R4__), yes)
# MM: Check!!!
OPT_ASM += -mcpu=cortex-r4 -mthumb -mthumb-interwork -Wa,-meabi=5
endif
...
OPT_LINK += -static -gc-sections

# Define HW architecture
ifeq ($(call iseeopt, __CORTEX_R4__), yes)
# MM: Check!!!
OPT_LINK += -mcpu=cortex-r4 -mthumb -mthumb-interwork -nostartfiles
endif
