...
#ifndef __INCLUDE_CPU_CORTEX_RX_EE_CONTEXT__
#define __INCLUDE_CPU_CORTEX_RX_EE_CONTEXT__
...
{
    EE_cortex_rx_change_context(EE_std_mark_tid_stacked(tid));
}
...
{
    EE_cortex_rx_change_context(tid);
}
...
#endif /* __INCLUDE_CPU_CORTEX_RX_EE_CONTEXT__ */
