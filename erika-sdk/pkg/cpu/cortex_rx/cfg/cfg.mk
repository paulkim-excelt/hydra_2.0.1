...
## Derived from cpu/cortex_mx/cfg/cfg.mk

ifeq ($(call iseeopt, __CORTEX_RX__), yes)
EE_SRCS += pkg/cpu/cortex_rx/src/ee_context.c
EE_SRCS += pkg/cpu/cortex_rx/src/ee_exceptions.c
...
EE_SRCS += pkg/cpu/cortex_rx/src/ee_gnu_oo.S
endif
endif	# CPU_OO
...
ifeq ($(call iseeopt, __GNU__), yes)
EE_SRCS += pkg/cpu/cortex_rx/src/ee_gnu_multi_context.S
endif
endif	# __MULTI__
...
ifeq ($(call iseeopt, __GNU__), yes)
EE_SRCS += pkg/cpu/cortex_rx/src/ee_gnu_irq_stack.S
endif
