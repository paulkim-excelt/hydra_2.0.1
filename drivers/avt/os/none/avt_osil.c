...
/**
    ...
    @file avt_osil.c
    @brief AVT Driver Integration Implementation
    This header file contains the integration implementation for AVT Driver
...
/**
    @name AVT driver Integration Design IDs
    @{
    @brief Integration Design IDs for AVT Driver
*/
...
/**
    ...
    if aIO is not NULL
        AVT_SysCmdHandler(SVC_MAGIC_AVT_ID, aCmd, (uint8_t*)aIO);
        ret = aIO->retVal;
    return ret;
