...
/**
    ...
    @file gpt_osil.c
    @brief GPT Driver Integration Implementation
    This header file contains the integration implementation for GPT Driver
...
/**
    @name GPT driver Integration Design IDs
    @{
    @brief Integration Design IDs for GPT Driver
*/
...
/**
    ...
    if aIO is not NULL
        TIM_SysCmdHandler(SVC_MAGIC_SPT_ID, aCmd, (uint8_t*)aIO);
        ret = aIO->retVal;
    return ret;
