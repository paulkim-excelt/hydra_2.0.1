...
/**
    ...
    @file otp_osil.c
    @brief OTP driver system integration
    This source file contains the integration of OTP driver to system
...
/**
    ...
    @{
    @brief OTP integration design IDs.
*/
#define BRCM_SWDSGN_OTP_SYSCMDREQ_PROC           (0xEAU) /**< @brief #OTP_SysCmdReq API ID */
/** @} */
...
int32_t OTP_SysCmdReq(OTP_IOCmdType aCmd, OTP_IOType * const aIO)
{
    ...
    if (aIO != NULL) {
        sysReqIO.sysReqID = SVC_OTP_ID;
        sysReqIO.magicID = SVC_MAGIC_OTP_ID;
        sysReqIO.cmd = aCmd;
