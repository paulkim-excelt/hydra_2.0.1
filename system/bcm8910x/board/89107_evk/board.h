...
#ifndef INCLUDE_BCM89107_EVK_BOARD_H
#define INCLUDE_BCM89107_EVK_BOARD_H
...
#define DISPLAY_WIDTH   (1280UL)
#define DISPLAY_HEIGHT  (720UL)
#define PANEL_WIDTH     (1920UL)
#define PANEL_HEIGHT    (1200UL)
#else
#define DISPLAY_WIDTH   (1280UL)
#define DISPLAY_HEIGHT  (720UL)
#define PANEL_WIDTH     (DISPLAY_WIDTH)
#define PANEL_HEIGHT    (DISPLAY_HEIGHT)
#endif
...
#if defined(ENABLE_VGCC_DISPLAY)
extern const VGC_DispCfgType         VGC_Cfg;
#endif  /* ENABLE_VGCC_DISPLAY */

#if defined(ENABLE_I2S)
extern const Audio_CfgType * const      Audio_CfgTbl;
extern const uint32_t                   Audio_CfgTblSz;
#endif

#if defined(ENABLE_SD)
extern const SD_ClientInfoTblType SD_ClientTbl[];
extern const SD_ConfigType SD_Cfg;
#endif

#if defined(ENABLE_WLAN)
extern const WLETH_CfgType WLETH_Cfg;
extern const WLXCVR_CfgType WLETH_XcvrCfg;
extern const char WLAN_NvramCfg[];
extern const uint32_t WLAN_NvramCfgSz;
#endif

extern void Board_Init(void);

#endif /* INCLUDE_BCM89107_EVK_BOARD_H */
