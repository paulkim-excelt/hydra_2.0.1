 ...
 */
#define BRCM_SWARCH_SYS_SENDCMD_PROC    (0xD0U) /**< @brief #SYS_SendCmd */
#define BRCM_SWARCH_SYS_CMDSTATUS_PROC  (0xD1U) /**< @brief #SYS_CmdStatus */
/** @} */

extern const RPC_CompType SYS_RpcIfc ;
#endif /* SYS_IPC_H */
/** @} */
