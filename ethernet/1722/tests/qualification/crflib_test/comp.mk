...
BRCM_CFLAGS += -DENABLE_1722

BRCM_INC += $(BRCM_SDK_ROOT)/system/include
BRCM_INC += $(BRCM_SDK_ROOT)/ethernet/1722/inc

BRCM_SRC += $(BRCM_SDK_ROOT)/ethernet/1722/tests/qualification/crflib_test/crflib_qt.c

BRCM_COMP_NAME := crflib_qt
BRCM_COMP_DEPENDS := 1722
BRCM_COMP_TYPE := app
