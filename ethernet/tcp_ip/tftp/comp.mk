...
##  @defgroup grp_tftp TFTP
#   @ingroup grp_comms_sw
#
#   @addtogroup grp_tftp
#   @{
#   @file ethernet/tcp_ip/tftp/comp.mk
#   @brief Makefile for TFTP files
...
BRCM_CONFIGURATION_ITEM += doc/tftp_req.c
BRCM_CONFIGURATION_ITEM += inc/tftp.h
BRCM_CONFIGURATION_ITEM += lib/tftp.c
BRCM_CONFIGURATION_ITEM += tests/qualification/tftp_qt/tftp_qt.h
