...
#BRCM_CFLAGS += -DDISABLE_INET_LOOPBACK_TEST=1
BRCM_CFLAGS += -DENABLE_MAC1=1
BRCM_CFLAGS += -DINET_TEST=1

BRCM_SRC := $(BRCM_SDK_ROOT)/ethernet/tcp_ip/inet/tests/qualification/udp/code.c

BRCM_COMP_NAME := inetudp_qt
