...
BRCM_CFLAGS += -DRTPTS_LOOPBACK_TEST=1UL
BRCM_APP_CFG_XML=application
BRCM_CFLAGS += -DRTP_ENABLE_RTCP_1733_SUPPORT=1
BRCM_CFLAGS += -DRTP_ENABLE_MPEGTS_PACKETIZATION=1
...
BRCM_SRC := $(BRCM_SDK_ROOT)/ethernet/tcp_ip/rtp/tests/qualification/rtptscomp_test/rtpts_test.c
BRCM_SRC += $(BRCM_SDK_ROOT)/ethernet/tcp_ip/rtp/tests/qualification/rtptscomp_test/ex_src_comp_core.c

BRCM_COMP_NAME := rtpts_qt
BRCM_COMP_DEPENDS := inet mpegts rtp
BRCM_COMP_TYPE := app
