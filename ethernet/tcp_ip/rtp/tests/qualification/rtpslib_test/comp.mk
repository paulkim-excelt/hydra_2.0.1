...
BRCM_INC += $(BRCM_SDK_ROOT)/ethernet/tcp_ip/rtp/tests/qualification/rtpslib_test

BRCM_SRC += $(BRCM_SDK_ROOT)/ethernet/tcp_ip/rtp/tests/qualification/rtpslib_test/code.c

BRCM_COMP_NAME := rtpslib_qt
BRCM_COMP_DEPENDS := rtp
BRCM_COMP_TYPE := app
