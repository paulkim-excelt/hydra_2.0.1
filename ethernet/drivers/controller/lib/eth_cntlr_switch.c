...
{
#if defined(ENABLE_ETH_SWITCH)
    return ETHERSWT_TxAdaptBuffer(aCntrlID, aBufIdx, aDataInOut, aLenInOut);
#else
    return BCM_ERR_OK;
#endif
}
...
{
#if defined(ENABLE_ETH_SWITCH)
    return ETHERSWT_TxProcessFrame(aCntrlID, aBufIdx, aDataInOut, aLenInOut);
#else
    return BCM_ERR_OK;
#endif
}
...
{
#if defined(ENABLE_ETH_SWITCH)
    return ETHERSWT_TxDoneInd (aCntrlID, aBufIdx);
#else
    return BCM_ERR_OK;
#endif
}
...
{
#if defined(ENABLE_ETH_SWITCH)
    return ETHERSWT_RxProcessFrame(aCntrlID, aBufIdx, aDataInOut, aLenInOut, aIsMgmtFrameOnly);
#else
    return BCM_ERR_OK;
#endif
}
...
{
#if defined(ENABLE_ETH_SWITCH)
    return ETHERSWT_RxDoneInd(aCntrlID, aBufIdx);
#else
    return BCM_ERR_OK;
#endif
}
