...
BRCM_APP_CFG_XML := switch
else
BRCM_APP_CFG_XML := endpt
endif

BRCM_SRC := $(BRCM_SDK_ROOT)/ethernet/802.1as/tests/qualification/comp/code.c
BRCM_SRC += $(BRCM_SDK_ROOT)/ethernet/802.1as/tests/qualification/comp/nif.c

BRCM_COMP_NAME := etscomp_qt
