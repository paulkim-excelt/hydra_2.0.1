...
static const MCU_ClkCfgType BL_ClkCfgTbl[] = {
    {
        .cfgID = BL_MCU_CLK_CFG_ID_QSPI0_SRC400_80MHZ,   /* QSPI0 @ 80MHZ */
        .clkRef = {
    ...
    {
        .cfgID = BL_MCU_CLK_CFG_ID_QSPI0_SRC400_66MHZ,   /* QSPI0 @ 66MHZ */
        .clkRef = {
            .clkID = BL_BCM_MCU_CLK_ID_QSPI,
            .freq = BL_FREQ_MHZ(66),
            .cntrl = {[0] = 0x3, [1] = 0x5},
    ...
    {
        .cfgID = BL_MCU_CLK_CFG_ID_QSPI0_SRC400_50MHZ,   /* QSPI0 @ 50MHZ */
        .clkRef = {
            .clkID = BL_BCM_MCU_CLK_ID_QSPI,
            .freq = BL_FREQ_MHZ(50),
            .cntrl = {[0] = 0x3, [1] = 0x7},
    ...
    {
        .cfgID = BL_MCU_CLK_CFG_ID_QSPI0_SRC200_25MHZ,   /* QSPI0 @ 25MHZ */
        .clkRef = {
            .clkID = BL_BCM_MCU_CLK_ID_QSPI,
            .freq = BL_FREQ_MHZ(25),
            .cntrl = {[0] = 0x2, [1] = 0x7},
