...
/**
 *  @file OVX0.h
 *  @brief openvx media component interface function headers
 *
 *  This file contains the interface function definitions for openvx media component
 *
 */

 /**
    @defgroup grp_openvx OpenVX
...
*/
#define BRCM_ARCH_OPENVX_GETFNTABLE_PROC         (0x00U) /**< @brief #OVX0_GetCompFnTable */
/** @} */
...
/** @brief Get the functon table
    ...
    @trace  #BRCM_ARCH_OPENVX_GETFNTABLE_PROC  #BRCM_REQ_OPENVX_MEDIA_COMPONENT

    @limitations None
*/
extern const MSYS_CompFnTblType* OVX0_GetCompFnTable(void);
