...
BRCM_SRC := $(BRCM_SDK_ROOT)/multimedia/pp/avcd/tests/qualification/avcd_test.c
BRCM_SRC += $(BRCM_SDK_ROOT)/multimedia/pp/avcd/tests/qualification/src_comp.c
BRCM_SRC += $(BRCM_SDK_ROOT)/multimedia/pp/avcd/tests/qualification/sink_comp.c
...
BRCM_COMP_NAME := avcd_qt
BRCM_COMP_DEPENDS := pplib avcd
BRCM_COMP_TYPE := app
