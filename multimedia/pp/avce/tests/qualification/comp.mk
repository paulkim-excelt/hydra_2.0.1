...
BRCM_SRC := $(BRCM_SDK_ROOT)/multimedia/pp/avce/tests/qualification/avce_test.c
BRCM_SRC += $(BRCM_SDK_ROOT)/multimedia/pp/avce/tests/qualification/src_comp.c
BRCM_SRC += $(BRCM_SDK_ROOT)/multimedia/pp/avce/tests/qualification/sink_comp.c
...
BRCM_CFLAGS += -DAVCE_NUM_PP_CORES=2UL
BRCM_CFLAGS += -DMEDIA_SYSTEM_SLICE_HEIGHT=32UL
...
BRCM_COMP_NAME := avce_qt
BRCM_COMP_DEPENDS := pplib avce
BRCM_COMP_TYPE := app
