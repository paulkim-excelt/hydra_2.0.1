...
/**
 * @file venc.h
 * @brief Video Encoder interface functions to interact.
 *
 * This header file defines the interface functions for video Encoder library.
 */
...
*/
#define BRCM_ARCH_VENC_GETFNTABLE_PROC         (0x00U) /**< @brief #VENC_GetCompFnTable */
/** @} */
...
/** @brief Get the functon table
    ...
    @trace  #BRCM_ARCH_VENC_GETFNTABLE_PROC  #BRCM_REQ_VENC_MEDIA_COMPONENT

    @limitations None
*/
extern const MSYS_CompFnTblType* VENC_GetCompFnTable(void);
