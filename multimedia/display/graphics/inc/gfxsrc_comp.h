...
/**
 *  @file gfxsrc_comp.h
 *  @brief graphics source component interface function headers
 *
 *  This file contains the interface function definitions for graphics source component
 *
 */
#ifndef GFXSRC_H
#define GFXSRC_H
...
*/
#define BRCM_ARCH_GFXSRC_GETFNTABLE_PROC         (0x00U) /**< @brief #GfxSrc_GetCompFnTable */
/** @} */
...
/** @brief Get the functon table
    ...
    @trace  #BRCM_ARCH_GFXSRC_GETFNTABLE_PROC  #BRCM_REQ_GFXSRC_MEDIA_COMPONENT

    @limitations None
*/
extern const MSYS_CompFnTblType* GfxSrc_GetCompFnTable(void);
