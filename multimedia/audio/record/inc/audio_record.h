...
/* Audio record component API IDs for report error */
/**< AudioRecord_SendCmd API ID */
#define AUDIO_REC_SEND_CMD_API_ID                   (0x00U)
/**< AudioRecord_RecvResp API ID */
#define AUDIO_REC_RECV_RESP_API_ID                  (0x01U)
/**< AudioRecord_GetNumMediaOutPort API ID */
#define AUDIO_REC_GET_NUM_MEDIA_OUTPORT_API_ID      (0x02U)
/**< AudioRecord_GetMediaOutPort API ID */
#define AUDIO_REC_GET_MEDIA_OUTPORT_API_ID          (0x03U)
/**< AudioRecord_GetMediaOutPortConfig API ID */
#define AUDIO_REC_GET_MEDIA_OUTPORT_CONFIG_API_ID   (0x04U)
/**< AudioRecord_PrintStatistics API ID */
#define AUDIO_REC_PRINT_STATISTICS_API_ID           (0x05U)

/** @brief Post a command to audio record component
 *
