...
******************************************************************************/
#ifndef UNICAM_IMAGE_UTIL_H
#define UNICAM_IMAGE_UTIL_H

#include "unicam_osil.h"

/******************************************************************************
File Name:  unicam_image_util.h
Descritpion: Unicam API's for Image writer, Image reader and get Unicam
             syntax tables.
******************************************************************************/
