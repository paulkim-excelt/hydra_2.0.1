...
CAMERA_CFG = ox03a10_csi_720p_16_dcg_12_vs_isp_hdr_test
...
BRCM_CFLAGS += -DCAMERA_TASK=ISPQT_Task
BRCM_CFLAGS += -DMAX_VIDEO_WIDTH=1280UL
BRCM_CFLAGS += -DMAX_VIDEO_HEIGHT=720UL

BRCM_CFLAGS += -DISPQT_HACK_ISPIMGV2_STAGE_EN_FLAGS
...
BRCM_INC += $(BRCM_SDK_ROOT)/multimedia/camera/configurations/xml/outputs/ov10640_csi
...
BRCM_SRC += $(BRCM_SDK_ROOT)/multimedia/camera/isys/tests/qualification/isp/isp_qt.c
BRCM_SRC += $(BRCM_SDK_ROOT)/multimedia/camera/isys/tests/qualification/isp/isp_config.c

BRCM_COMP_NAME := isp_qt
BRCM_COMP_DEPENDS := isys
BRCM_COMP_TYPE := app
