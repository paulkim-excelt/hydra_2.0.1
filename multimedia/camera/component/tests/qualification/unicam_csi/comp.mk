...
BRCM_CFLAGS += -DENABLE_CAMERA_SENSOR=1
...
BRCM_CFLAGS += -DCAMERA_TASK=UNICAM_CSITestTask
...
BRCM_SRC += $(BRCM_SDK_ROOT)/multimedia/camera/component/tests/qualification/unicam_csi/unicam_csi_qt.c

BRCM_COMP_NAME := unicam_csi_qt
