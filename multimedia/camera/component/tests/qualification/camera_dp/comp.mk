...
BRCM_SRC += $(BRCM_SDK_ROOT)/multimedia/camera/component/tests/qualification/camera_dp/camera_dp_comp_test.c
BRCM_SRC += $(BRCM_SDK_ROOT)/multimedia/camera/component/tests/qualification/camera_dp/ex_sink_comp_core.c

BRCM_CFLAGS += -DMEDIA_SYSTEM_MAX_VIDEO_WIDTH=1280UL
BRCM_CFLAGS += -DMEDIA_SYSTEM_MAX_VIDEO_HEIGHT=720UL
BRCM_CFLAGS += -DCAMERA_MAX_SENSOR_WIDTH=1920UL
BRCM_CFLAGS += -DCAMERA_MAX_SENSOR_HEIGHT=1080UL
BRCM_CFLAGS += -DMEDIA_SYSTEM_MAX_VIDEO_FPS=30UL
BRCM_CFLAGS += -DCAMERA_TEST_EVENT_PASS=SystemEvent0
BRCM_CFLAGS += -DCAMERA_TEST_EVENT_FAIL=SystemEvent1

BRCM_COMP_NAME := camera_dp_qt
