...
BRCM_INC += $(BRCM_SDK_ROOT)/multimedia/camera/tuners/denoise/inc
BRCM_INC += $(BRCM_SDK_ROOT)/multimedia/camera/sensor/inc

#Sources
BRCM_SRC += $(BRCM_SDK_ROOT)/multimedia/camera/tuners/denoise/lib/tuner_denoise.c
endif

BRCM_COMP_NAME := isys_denoise
BRCM_COMP_DEPENDS :=
