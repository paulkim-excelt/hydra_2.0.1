...
BRCM_INC += $(BRCM_SDK_ROOT)/multimedia/camera/tuners/awb/inc
BRCM_INC += $(BRCM_SDK_ROOT)/multimedia/camera/sensor/inc

#AWB Sources
BRCM_SRC += $(BRCM_SDK_ROOT)/multimedia/camera/tuners/awb_gw/lib/tuner_awb_gw.c
endif

BRCM_COMP_NAME := isys_awb_gw
